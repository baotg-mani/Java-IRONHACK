...
public class PaymentController {
	...
	public ResponseEntity<Object> createPaymentByCustomerId(@PathVariable Integer customerId, @RequestBody Payment cPayment){
	...
	public ResponseEntity<Object> updatePayment(@PathVariable Integer id, @RequestBody Payment cPayment) {
		...
		if (paymentData.isPresent()) {
			try {
				...
				newUpdate.setCustomer(cPayment.getCustomer()); 
