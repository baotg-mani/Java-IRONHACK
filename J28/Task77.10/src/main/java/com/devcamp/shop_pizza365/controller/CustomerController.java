...
public class CustomerController {
	...
	public ResponseEntity<Object> createCustomer(@RequestBody Customer cCustomer){
			try {
				...
				vCustomer.setOrders(cCustomer.getOrders());
				vCustomer.setPayments(cCustomer.getPayments());
	...
	public ResponseEntity<Object> updateCustomer(@PathVariable Integer id, @RequestBody Customer cCustomer) {
		...
		if (customerData.isPresent()) {
			try {
				...
				newUpdate.setOrders(cCustomer.getOrders());
				newUpdate.setPayments(cCustomer.getPayments());
