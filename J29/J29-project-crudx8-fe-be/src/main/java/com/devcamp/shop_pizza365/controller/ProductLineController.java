...
public class ProductLineController {
	...
	public ResponseEntity<Object> getAllProductLine() {
		try {
			return new ResponseEntity<>(pProductLineRepository.findAllProductLine(), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Object> updateProductLine(@Valid @PathVariable Integer id, @RequestBody ProductLine cProductLine) {
